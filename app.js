  ...
  document.getElementById("btnsearch").onclick = function(){
    ...
    fetch(`http://api.weatherapi.com/v1//current.json?key=9da2e733fd05417db69161750241209&q=${location}`,reop)
       ...
       .then(data =>{
        ...
        document.getElementById("locationx").innerHTML=data["location"]["name"];
        document.getElementById("temp_cx").innerHTML=data["current"]["temp_c"];
        document.getElementById("dscriptionx").innerHTML=data["current"]["condition"]["text"];
